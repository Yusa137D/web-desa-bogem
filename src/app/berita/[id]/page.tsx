    ...
    return (
      <main className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-4">
        <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-slate-200/80 max-w-md w-full text-center space-y-4">
          ...
          <h1 className="text-xl font-extrabold text-slate-900">Berita Tidak Ditemukan</h1>
          <p className="text-xs text-slate-600 leading-relaxed">
            Artikel warta desa yang Anda tuju mungkin telah diperbarui atau dipindahkan oleh pengelola.
          </p>
          <div className="pt-2">
            <Link
              href="/berita"
