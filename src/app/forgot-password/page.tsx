...
import { Mail, ArrowRight, Store, AlertCircle, CheckCircle2, Loader2, ArrowLeft, KeyRound, CreditCard } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-4 py-12">
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-extrabold text-slate-900">Pemulihan Kata Sandi</h1>
          ...
          {successEmail ? (
            ...
            <>
              ...
              <div className="text-center pt-2 border-t border-slate-100">
                <Link
                  href="/login"
                  className="inline-flex items-center space-x-1.5 text-xs font-bold text-slate-600 hover:text-[#004329]"
                >
